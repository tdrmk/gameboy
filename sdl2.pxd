...
cdef extern from "SDL2/SDL_stdinc.h" nogil:
...
cdef extern from "SDL2/SDL_version.h" nogil:
...
cdef extern from "SDL2/SDL_revision.h" nogil:

    const char* SDL_REVISION # macro
    int SDL_REVISION_NUMBER # macro

cdef extern from "SDL2/SDL_error.h" nogil:
...
cdef extern from "SDL2/SDL_rwops.h" nogil:

    ctypedef struct SDL_RWops:
        pass

cdef extern from "SDL2/SDL_timer.h" nogil:
...
cdef extern from "SDL2/SDL_rect.h" nogil:
...
cdef extern from "SDL2/SDL_pixels.h" nogil:
...
cdef extern from "SDL2/SDL_blendmode.h" nogil:
...
cdef extern from "SDL2/SDL_surface.h" nogil:
...
cdef extern from "SDL2/SDL_video.h" nogil:
...
cdef extern from "SDL2/SDL_render.h" nogil:
...
cdef extern from "SDL2/SDL_audio.h" nogil:
...
cdef extern from "SDL2/SDL_scancode.h" nogil:
...
cdef extern from "SDL2/SDL_keycode.h" nogil:
...
cdef extern from "SDL2/SDL_keyboard.h" nogil:
...
cdef extern from "SDL2/SDL_mouse.h" nogil:
...
cdef extern from "SDL2/SDL_joystick.h" nogil:
...
cdef extern from "SDL2/SDL_gamecontroller.h" nogil:
...
cdef extern from "SDL2/SDL_touch.h" nogil:
...
cdef extern from "SDL2/SDL_gesture.h" nogil:
...
cdef extern from "SDL2/SDL_events.h" nogil:
...
cdef extern from "SDL2/SDL_hints.h" nogil:
...
cdef extern from "SDL2/SDL_platform.h" nogil:
